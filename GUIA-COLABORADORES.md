...
| `FTP_SERVER_DIR` | Carpeta remota donde vive la web. Para la cuenta FTP `u777838732.matchpointmvd` (ya apunta a `public_html`), usá **`/`** — no `/public_html/` (eso crea una subcarpeta y la web sigue vieja). Debe terminar en `/`. |
